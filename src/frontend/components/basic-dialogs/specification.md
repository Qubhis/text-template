...
*Complete 1:1 extraction with all accordions systematically expanded. All visible specifications from the Material Design 3 Basic Dialogs page have been captured with proper CSS variable naming conversion.*